...
export const metadata: Metadata = {
  title: "News & Insights - Pantos Equestrian",
  description: "Stay updated with the latest equestrian news, training tips, and facility updates from Pantos Equestrian."
};
  ...
  return (
    <>
      <Breadcrumb
        ...
        description="Stay informed with the latest equestrian news, expert training tips, and updates from Pantos Equestrian."
      />
